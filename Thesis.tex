...
\begin{abstract}
  W dzisiejszych czasach znaczenie analizy dużej objętości danych staje się bardziej i bardziej oczywista. Coraz więcej firm decyduje się otworzyć dział analizy danych w celu poprawy własnej oferty; inne z analizy danach utworzyły ofertę dla innych firm. Praca inżynierska prezentuje wybrane metody analizy danych oferowane przez środowisko programowania Python, szeroko wykorzystanym w dziedzinie danologii. Szczególną uwagę poświęcono na pokazaniu czytelnikowi przykładów, jak można wykorzystać Python dla analizy danych z publicznie dostępnych źródeł przez prezentacje kodu z różnych projektów, jak i przykładowych wyników, które mogą zostać uzyskane.
\end{abstract}
\end{otherlanguage}
\smallskip
\begin{abstract}
...
\bgroup
  ...
  \captionof{listing}{Verifying the transformation}
...
\begin{figure}[H]
    \centering
    \fbox{\includegraphics[width=\textwidth]{src/youtube/datashader/communities/datashader_comm_nospread}}
...
\begin{figure}[H]
    \centering
    \fbox{\includegraphics[width=\textwidth]{src/youtube/datashader/communities/datashader_comm_spread}}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{src/geo/map/plot_phones}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{src/geo/map/plot_urban}
...
\bgroup
  ...
  \captionof{listing}{Loading the data using dask}
...
\bgroup
  ...
  \captionof{listing}{Data transformation functions}
...
\bgroup
  ...
  \captionof{listing}{Executing the transformation}
...
\bgroup
  ...
  \captionof{listing}{Preparing to make the plots}
...
\bgroup
  ...
  \captionof{listing}{Creating the plot functions}
...
\bgroup
  ...
  \captionof{listing}{Plotting the data}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{src/geo/ds/pickups}
    \caption{Pickup plot}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{src/geo/ds/dropoffs}
